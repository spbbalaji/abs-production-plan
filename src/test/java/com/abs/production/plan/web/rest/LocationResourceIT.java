...
import com.abs.production.plan.domain.Country;
import com.abs.production.plan.domain.Location;
import com.abs.production.plan.repository.LocationRepository;
import com.abs.production.plan.service.criteria.LocationCriteria;
...
class LocationResourceIT {
    ...
    @Test
    @Transactional
    void getAllLocationsByStreetAddressIsNotEqualToSomething() throws Exception {
        // Initialize the database
        locationRepository.saveAndFlush(location);
    ...
    @Test
    @Transactional
    void getAllLocationsByCityIsNotEqualToSomething() throws Exception {
        // Initialize the database
        locationRepository.saveAndFlush(location);
    ...
    @Test
    @Transactional
    void getAllLocationsByStateProvinceIsNotEqualToSomething() throws Exception {
        // Initialize the database
        locationRepository.saveAndFlush(location);
