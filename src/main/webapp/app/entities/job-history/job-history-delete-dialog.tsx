...
export const JobHistoryDeleteDialog = (props: IJobHistoryDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="productionPlanApp.jobHistory.delete.question">
        <Translate contentKey="productionPlanApp.jobHistory.delete.question" interpolate={{ id: jobHistoryEntity.id }}>
