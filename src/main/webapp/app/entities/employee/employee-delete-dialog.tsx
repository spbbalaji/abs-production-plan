...
export const EmployeeDeleteDialog = (props: IEmployeeDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="productionPlanApp.employee.delete.question">
        <Translate contentKey="productionPlanApp.employee.delete.question" interpolate={{ id: employeeEntity.id }}>
