  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="productionPlanApp.country.home.createOrEditLabel" data-cy="CountryCreateUpdateHeading">
            <Translate contentKey="productionPlanApp.country.home.createOrEditLabel">Create or edit a Country</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : countryEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                <AvField id="country-countryName" data-cy="countryName" type="text" name="countryName" />
              </AvGroup>
              <AvGroup>
                <Label for="country-region">
                  <Translate contentKey="productionPlanApp.country.region">Region</Translate>
                </Label>
                <AvInput id="country-region" data-cy="region" type="select" className="form-control" name="regionId">
                  <option value="" key="0" />
                  {regions
