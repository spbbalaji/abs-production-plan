  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="productionPlanApp.job.home.createOrEditLabel" data-cy="JobCreateUpdateHeading">
            <Translate contentKey="productionPlanApp.job.home.createOrEditLabel">Create or edit a Job</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : jobEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="jobTitleLabel" for="job-jobTitle">
                  <Translate contentKey="productionPlanApp.job.jobTitle">Job Title</Translate>
                </Label>
                <AvField id="job-jobTitle" data-cy="jobTitle" type="text" name="jobTitle" />
              </AvGroup>
              <AvGroup>
                <Label id="minSalaryLabel" for="job-minSalary">
                  <Translate contentKey="productionPlanApp.job.minSalary">Min Salary</Translate>
                </Label>
              ...
              <AvGroup>
                <Label id="maxSalaryLabel" for="job-maxSalary">
                  <Translate contentKey="productionPlanApp.job.maxSalary">Max Salary</Translate>
                </Label>
                <AvField id="job-maxSalary" data-cy="maxSalary" type="string" className="form-control" name="maxSalary" />
              </AvGroup>
              <AvGroup>
                <Label for="job-task">
                  <Translate contentKey="productionPlanApp.job.task">Task</Translate>
                </Label>
                <AvInput
                  id="job-task"
                  data-cy="task"
              ...
              <AvGroup>
                <Label for="job-employee">
                  <Translate contentKey="productionPlanApp.job.employee">Employee</Translate>
                </Label>
