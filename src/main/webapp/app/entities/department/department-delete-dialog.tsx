...
export const DepartmentDeleteDialog = (props: IDepartmentDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="productionPlanApp.department.delete.question">
        <Translate contentKey="productionPlanApp.department.delete.question" interpolate={{ id: departmentEntity.id }}>
