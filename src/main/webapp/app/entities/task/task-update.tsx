  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="productionPlanApp.task.home.createOrEditLabel" data-cy="TaskCreateUpdateHeading">
            <Translate contentKey="productionPlanApp.task.home.createOrEditLabel">Create or edit a Task</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : taskEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                <AvField id="task-title" data-cy="title" type="text" name="title" />
              </AvGroup>
              <AvGroup>
