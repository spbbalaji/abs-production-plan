  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="productionPlanApp.region.home.createOrEditLabel" data-cy="RegionCreateUpdateHeading">
            <Translate contentKey="productionPlanApp.region.home.createOrEditLabel">Create or edit a Region</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : regionEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                <AvField id="region-regionName" data-cy="regionName" type="text" name="regionName" />
              </AvGroup>
