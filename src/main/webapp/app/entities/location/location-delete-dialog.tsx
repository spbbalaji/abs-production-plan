...
export const LocationDeleteDialog = (props: ILocationDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="productionPlanApp.location.delete.question">
        <Translate contentKey="productionPlanApp.location.delete.question" interpolate={{ id: locationEntity.id }}>
