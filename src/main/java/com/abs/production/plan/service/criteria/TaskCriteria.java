...
/**
 * Criteria class for the {@link com.abs.production.plan.domain.Task} entity. This class is used
 * in {@link com.abs.production.plan.web.rest.TaskResource} to receive all the possible filtering options from
...
public class TaskCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, title, description, jobId);
    }
