...
/**
 * Criteria class for the {@link com.abs.production.plan.domain.Job} entity. This class is used
 * in {@link com.abs.production.plan.web.rest.JobResource} to receive all the possible filtering options from
...
public class JobCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, jobTitle, minSalary, maxSalary, taskId, employeeId);
    }
