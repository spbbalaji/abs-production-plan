package com.abs.production.plan.service.criteria;

import com.abs.production.plan.domain.enumeration.Language;
...
/**
 * Criteria class for the {@link com.abs.production.plan.domain.JobHistory} entity. This class is used
 * in {@link com.abs.production.plan.web.rest.JobHistoryResource} to receive all the possible filtering options from
...
public class JobHistoryCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, startDate, endDate, language, jobId, departmentId, employeeId);
    }
